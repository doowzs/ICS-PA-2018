...
opcode_entry opcode_table [512] = {
  ...
  /* 0x80 */	IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp),
  /* 0x84 */	IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp),
  /* 0x88 */	IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp),
  /* 0x8c */	IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp), IDEX(J, jmp),
